...
async function run() {
  try {
    ...
    await sequelize.query(`INSERT IGNORE INTO smart_improvement_rates (patient_id, treatment_id, doctor_id, rate, createdAt, updatedAt) VALUES (999, 999, ${doctor.id}, 85.5, NOW(), NOW())`).catch(() => {});
